...
class OpcionMenuTest extends TestCase
{
    ...
    public function test_can_list_menu_options_flat()
    {
        ...
        $response = $this->actingAs($this->user)->getJson('/v1/opciones-menu');
    ...
    public function test_can_list_menu_options_as_tree()
    {
        ...
        $response = $this->actingAs($this->user)->getJson('/v1/opciones-menu?tree=true');
    ...
    public function test_can_create_menu_option()
    {
        ...
        $response = $this->actingAs($this->user)->postJson('/v1/opciones-menu', $payload);
    ...
    public function test_can_show_menu_option()
    {
        ...
        $response = $this->actingAs($this->user)->getJson("/v1/opciones-menu/{$opcion->id}");
    ...
    public function test_can_update_menu_option()
    {
        ...
        $response = $this->actingAs($this->user)->putJson("/v1/opciones-menu/{$opcion->id}", $payload);
    ...
    public function test_can_soft_delete_menu_option()
    {
        ...
        $response = $this->actingAs($this->user)->deleteJson("/v1/opciones-menu/{$padre->id}");

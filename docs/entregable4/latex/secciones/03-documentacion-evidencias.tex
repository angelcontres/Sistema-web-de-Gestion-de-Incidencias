...
\begin{itemize}
    ...
    \begin{itemize}
        \item \textbf{Resultado:} [Aprobado/Fallido]
    ...
    \item \textbf{CP-F-04} (Cambio de estado) - Fecha: xx/07/2026
    \begin{itemize}
        \item \textbf{Resultado:} [Fallido]
        \item \textit{Evidencia:}
    ...
    \item \textbf{CP-F-05} (Historial de cambios) - Fecha: xx/07/2026
    \begin{itemize}
        \item \textbf{Resultado:} [Fallido]
        \item \textit{Evidencia:} [AQUÍ SE ADJUNTARÁ EL LOG O PANTALLA DEL HISTORIAL]
    \end{itemize}
    ...
    \item \textbf{CP-F-07} (Agregar comentario) - Fecha: xx/07/2026
    \begin{itemize}
        \item \textbf{Resultado:} [Fallido]
        \item \textit{Evidencia:} La funcionalidad de comentarios aún no se encuentra implementada.
    \end{itemize}

    \item \textbf{CP-F-08} (Generar notificación) - Fecha: 7/07/2026
    \begin{itemize}
        \item \textbf{Resultado:} [Fallido]
        \item \textit{Evidencia:} La funcionalidad de envío de notificaciones automáticas no se encuentra implementada.
    \end{itemize}
    ...
    \item \textbf{CP-F-12} (Consulta por estado) - Fecha: 7/07/2026
    \begin{itemize}
        \item \textbf{Resultado:} [Fallido] %pendiente
        \item \textit{Evidencia:}
        
        % \begin{figure}[H] % La 'H' mayúscula obliga a la imagen a quedarse EXACTAMENTE aquí
        %     \centering
        %     \includegraphics[width=0.9\textwidth]{imagenes/cp-f-12.png}
        %     \caption{Evidencia.}
        % \end{figure}
    \end{itemize}
    \item \textbf{CP-F-13} (Consulta por tipo) - Fecha: xx/07/2026
    \begin{itemize}
        \item \textbf{Resultado:} [Fallido] %pendiente
        \item \textit{Evidencia:}
        ...
        % \begin{figure}[H] % La 'H' mayúscula obliga a la imagen a quedarse EXACTAMENTE aquí
        %     \centering
        %     \includegraphics[width=0.9\textwidth]{imagenes/cp-f-13.png}
        %     \caption{Evidencia.}
        % \end{figure}
    \end{itemize}
    \item \textbf{CP-F-14} (Dashboard métricas) - Fecha: 7/07/2026
    \begin{itemize}
        \item \textbf{Resultado:} [Aprobado parcialmente]
        \item \textit{Evidencia:}
        ...
        las no asignadas (se quitará ya que no aporta nada), las resueltas (cada que el encargado marque la incidencia como resuelta)
        y el tiempo de respuesta que es un número hardcodeado que calculará el tiempo de resolución promedio de las incidencias.

    \end{itemize}
    \item \textbf{CP-F-15} (Auditoría automática) - Fecha: 7/07/2026
    \begin{itemize}
        \item \textbf{Resultado:} [Aprobado parcialmente]
        \item \textit{Evidencia:}
...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \end{figure}
    \end{itemize}
    \item \textbf{CP-V-04} (Comentario supera longitud) - Fecha: 7/07/2026
    \begin{itemize}
        \item \textbf{Resultado:} [Fallido]
        \item \textit{Evidencia:} [AQUÍ SE ADJUNTARÁ LA CAPTURA DE PANTALLA: Validación de longitud excedida]
    \end{itemize}

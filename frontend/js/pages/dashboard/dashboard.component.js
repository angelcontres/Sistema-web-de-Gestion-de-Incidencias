...
export class DashboardComponent extends BaseComponent {
  ...
  initGrafanaDashboards() {
    ...
    const GRAFANA_DASHBOARDS = {
      ...
      Supervisor: `${GRAFANA_BASE}/d/addt7bq/prod-incidents-supervisor?orgId=1&from=now-24h&to=now&timezone=browser&theme=light&refresh=5m&kiosk&embed=v2&var_usuario_asignado_id=${userId}`,
      Institucion: `${GRAFANA_BASE}/d/ad6n9wt/prod-incidents-institucion?orgId=1&from=now-24h&to=now&timezone=browser&theme=light&refresh=10s&kiosk&embed=v2&var_institucion_id=${instId}&var_usuario_asignado_id=${userId}`,
      Ciudadano: `${GRAFANA_BASE}/d/adfds7b/prod-incidents-ciudadano?orgId=1&from=now-24h&to=now&timezone=browser&theme=light&refresh=30s&kiosk&embed=v2&var_usuario_reporta_id=${userId}`,
